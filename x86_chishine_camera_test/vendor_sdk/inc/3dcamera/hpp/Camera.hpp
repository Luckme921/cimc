...
public:
	...
	* @return         success:return SUCCESS, fail:other error code
	**/
	virtual ERROR_CODE featureReconstruct(IFramePtr frame, std::vector<Point2f>& leftFeaturePoints, std::vector<Point2f>& rightFeaturePoints, float confidenceThreshold, std::vector<Point3f>& reconstructPoints) = 0;
	...
	* @return     success:return SUCCESS, fail:other error code
	**/
	virtual ERROR_CODE matchedFeatureReconstruct(IFramePtr frame, const std::vector<Point2f>& matchedLeftFeaturePoints, const std::vector<Point2f>& matchedRightFeaturePoints, std::vector<Point3f>& reconstructPoints) = 0;
	...
	* @~chinese
	* @brief      设置IMU标定日期
	* @param[in] calibrationDate		：标定日期
	* @return     成功:SUCCESS, 失败:其他错误码
	* @~english
	* @brief      Set IMU calibration date
	* @param[in] calibrationDate		：calibration date
	* @return success:return SUCCESS, fail:other error code
	**/
	...
	* @~chinese
	* @brief      获取IMU标定日期
	* @param[out] calibrationDate		：标定日期
	* @return     成功:SUCCESS, 失败:其他错误码
	* @~english
	* @brief      Get IMU calibration date
	* @param[out] calibrationDate		：calibration date
	* @return success:return SUCCESS, fail:other error code
	**/
