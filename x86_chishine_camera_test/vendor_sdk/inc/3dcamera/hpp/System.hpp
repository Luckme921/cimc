...
/**
* @~chinese
* \defgroup System 相机上下文系统
* @brief 相机上下文系统
* @{
* @~english
* \defgroup System System Operations
* @brief System object interface
* @{
*/
...
* @param[in]	addedCameras	当前的相机列表
* @param[in]	removedCameras	断开的相机列表
* @param[in]	userData	回调用户数据，在设置回调时传入
* @{
* @~english
* \defgroup camera state change callback
* @brief camera state change callback
* @param[in]	addedCameras	the camera list of current
* @param[in]	removedCameras	disconnect list of camera
...
/**
* @~chinese
*\defgroup System 相机告警监听回调定义
* @brief 相机告警回调函数,上报相机警告信息通道
* @param[in]	jsonData	上报数据，json数据格式
* @param[in]	iDataLen	json数据长度
* @param[in]	userData	回调用户数据，在设置回调时传入
* @{
* @~english
* \defgroup System Camera alarm monitor define
* @brief callback of camera alarm
...
public:
	...
	**/
	 ...
	 * @~chinese
	 * @brief      	初始化驱动
	 * @param[in]	code	:	初始化序列号
	 * @return     	成功:SUCCESS, 失败:其他错误码
	 * @~english	
	 * @brief		initializate the driver
	 * @param[in]	code	:	the initializate code of driver
	 * @return  success:return SUCCESS, fail:other error code
	 */
...
* @brief     网络功能开关
* @~english
* @brief     networking enable/disable
**/
...
* @brief     获取相机操作异常信息
* @~english
* @brief     get error information string
**/
...
* @brief     设置是否检查相机初始化
* @~english
* @brief     set camera init check enbale/disable
**/
...
* @brief     获取是否检查相机初始化
* @~english
* @brief     get camera init check enbale/disable
**/
