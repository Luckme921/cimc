...
typedef enum PROPERTY_TYPE_EXTENSION
{
	...
	PROPERTY_EXT_IS_SUPPORT_GYRO			= 0x19,		/**< @~chinese 判断相机是否支持陀螺仪		@~english the camera supports gyroscope or not, reference bSupportGyro*/
	PROPERTY_EXT_GET_GYRO_VERSION			= 0x20,		/**< @~chinese 获取相机陀螺仪版本信息		@~english get camera gyroscope version information,reference gyroVersion */
	PROPERTY_EXT_PARAM_FILE_MNG				= 0x21,		/**< @~chinese 参数文件管理					@~english camera paramer file management*/
	PROPERTY_EXT_FAR_NEAR_CAMERA_STATE		= 0x22,		/**< @~chinese 近远景相机状态				@~english far near camera state management*/
...
typedef union PropertyExtension
{
	...
	CalibrationStreamParma calibrationStreamParam; /**< @~chinese 对应PROPERTY_EXT_CHANGE_DEP_FORMAT  @~english corresponding PROPERTY_EXT_CHANGE_DEP_FORMAT */
